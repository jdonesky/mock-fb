...
const emojiSelector = (props) => {
    ...
    const sources = [
        ...
        {url: 'https://media.giphy.com/media/ViHbdDMcIOeLeblrbq/giphy.gif', caption: 'Sad', id:2},
        {url: 'https://media.giphy.com/media/kyQfR7MlQQ9Gb8URKG/giphy.gif', caption: 'Mad', id:3},
        {url: 'https://media.giphy.com/media/h4OGa0npayrJX2NRPT/giphy.gif', caption: 'Sorry', id:4},

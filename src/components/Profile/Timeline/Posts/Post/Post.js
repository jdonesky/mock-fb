...
const post = (props) => {
    ...
    let profileSummary;
    if (viewingSummary) {
        profileSummary = <ProfileSummary userType={props.userType} publicProfileKey={props.publicProfileKey} myFriends={props.friends} onMouseEnter={cancelCloseSummary} onMouseLeave={startClosingViewingSummary}/>
    }

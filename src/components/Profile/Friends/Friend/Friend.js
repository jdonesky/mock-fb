...
const friend = (props) => {
    ...
    let editButton;
    if (props.pathRoot === 'user-profile' && props.displayProfile === 'me') {
        editButton = (<div className={editButtonClasses.join(" ")} onClick={openDropdown}>{isFriend !== -1 ? 'Friends' : 'Add Friend'}</div>)
    }
